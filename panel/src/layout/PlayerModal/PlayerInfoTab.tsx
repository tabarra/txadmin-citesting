...
export default function PlayerInfoTab({ playerRef, player, serverTime, tsFetch, setSelectedTab, refreshModalData }: PlayerInfoTabProps) {
    ...
    return <div className="p-1">
        <dl className="pb-2">
            <div className="w-full p-2 pr-3 mb-1 flex items-center justify-between space-x-4 rounded-lg border shadow-lg transition-all text-black/75 dark:text-white/90 border-warning/70 bg-warning-hint animate-toastbar-enter">
                <div className="flex-shrink-0 flex flex-col gap-2 items-center">
                    <ShieldAlertIcon className="size-5 text-warning" />
                </div>
                <div className="flex-grow text-sm font-medium">
                    Banned until 2022-12-31 23:59:59 UTC
                </div>
            </div>
